...
def print_example_passed(description, run_time,filename)
  ...
  if !filename.nil?
     @output.puts "<span onclick=showScreen(\"#{filename}\") style=\"text-align=right;float:right\"><img style=\"width:10px\" src='data:image/png;base64,
...
<div id="rspec-header">
  <div id="label">
    <h1>PacteraPulse Automation Test</h1>
  </div>
